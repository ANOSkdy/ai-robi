...
import { renderTemplate, type DocumentType, type ResumeTemplateData } from '@/lib/render-template';
...
const ResumeDataSchema: z.ZodType<ResumeTemplateData> = z.object({
  profile: ProfileSchema.optional(),
  histories: z.array(HistorySchema).optional(),
  licenses: z.array(HistorySchema).optional(),
  motivation: z.string().optional(),
  selfPromotion: z.string().optional(),
  requests: z.string().optional(),
  jobSummary: z.string().optional(),
  jobDetails: z.array(JobDetailSchema).optional(),
});

const BodySchema = z.object({
  formData: ResumeDataSchema,
